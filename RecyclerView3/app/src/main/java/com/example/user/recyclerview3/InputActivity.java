...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        hotel = (Hotel) getIntent().getSerializableExtra(MainActivity.HOTEL); if (hotel != null) {
        ...
        hotel = (Hotel)
                ...
                getIntent().getSerializableExtra(MainActivity.HOTEL);
        if (hotel != null) {
            setTitle("Edit " + hotel.judul);
            filldata();
        } else {
    ...
    private void doSave() {
        ...
        if (isValid(judul, deskripsi, detail, lokasi, uriFoto)) { hotel = new Hotel(judul, deskripsi, detail, lokasi,
                uriFoto.toString());

            Intent intent = new Intent(); intent.putExtra(MainActivity.HOTEL, hotel); setResult(RESULT_OK, intent); finish();
    ...
    private boolean isValid(String judul, String deskripsi, String detail, String lokasi, Uri uriFoto) {
        ...
        if (uriFoto == null) { Snackbar.make(ivFoto, "Foto Belum Ada",
    ...
    public void setErrorEmpty(EditText editText) { editText.setError(((TextInputLayout)
            editText.getParent().getParent()).getHint() + "Belum diisi");
    ...
    private void pickPhoto() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) { intent = new Intent(Intent.ACTION_GET_CONTENT);
        } else {

            intent = new Intent(Intent.ACTION_OPEN_DOCUMENT); intent.addCategory(Intent.CATEGORY_OPENABLE);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_GET && resultCode == RESULT_OK) { uriFoto = data.getData();
            ivFoto.setImageURI(uriFoto);
