...
public class MainActivity extends AppCompatActivity implements HotelAdapter.IHotelAdapter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) { goAdd();
...
//	Inflate the menu; this adds items to the action bar if it is present.
        ...
        SearchView searchView = (SearchView)
                ...
                MenuItemCompat.getActionView(searchItem); searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            { mQuery = newText.toLowerCase(); doFilter(mQuery);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD && resultCode == RESULT_OK) { Hotel hotel = (Hotel) data.getSerializableExtra(HOTEL);
        mList.add(hotel);
...
//mAdapter.notifyDataSetChanged();
...

        {
            ...
            Hotel hotel = (Hotel) data.getSerializableExtra(HOTEL); mList.remove(itemPos);
            ...
            if (isFiltered) mListAll.add(mListMapFilter.get(itemPos), hotel); mAdapter.notifyDataSetChanged();
